...
(function() {
	...
	var originalOnFatalErrorCallback = function(tsp, errMsg) { alert("xRequest failed: " + errMsg); }
			...
			myGebDirections.route(
				...
				function(directionsResult, directionsStatus) {
					if (directionsStatus == google.maps.DirectionsStatus.OK) {
						...
						alert("Request failed: " + errorMsg + " origin: " + origin + " des: " + destination);
					}
				}
			);
		} else {
